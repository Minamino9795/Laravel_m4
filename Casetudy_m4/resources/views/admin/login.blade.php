...
<body class="bg-gray-200">
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-100"
            style="background-image: url('https://png.pngtree.com/background/20230410/original/pngtree-mountains-moon-nature-landscape-cartoon-background-decoration-pattern-picture-image_2385439.jpg');">
